package spring.core.factory.type1singleton;
...
public class TestFactory {
	public static void main(String args[]) {
		ApplicationContext context=new ClassPathXmlApplicationContext("spring\\core\\factory\\type1singleton\\applicationContext.xml");
